...
rm -f $KERNEL_PATH/releases/zip/$LOCALVERSION.zip
...
echo "push latest kernel.zip to sdcard"
sudo adb push $KERNEL_PATH/releases/zip/$LOCALVERSION.zip /sdcard/$LOCALVERSION.zip
